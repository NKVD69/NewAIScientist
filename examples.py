...
async def example_drug_repurposing():
    ...
    await co_scientist.run_hypothesis_generation_cycle(
        num_hypotheses=8
    )
...
async def example_multidomain_discovery():
    ...
    await co_scientist.run_hypothesis_generation_cycle(num_hypotheses=7)
    ...
    await co_scientist.run_tournament_cycle(num_matches=5)
...
async def example_scientist_in_the_loop():
    ...
    # Tournament
    await co_scientist.run_tournament_cycle(num_matches=4)
    ...
    for i, hyp in enumerate(meta_review['top_hypotheses'][:3], 1):
        ...
        print("     Ready for: Molecular validation experiments")
...
async def example_batch_processing():
    ...
    for idx, goal in enumerate(goals, 1):
        ...
        await co_scientist.run_tournament_cycle(num_matches=3)
        meta_review = await co_scientist.run_meta_review_cycle()
